class FridayBeta < Formula
  ...
  if Hardware::CPU.arm?
    url "https://api.github.com/repos/HeadstartAI/friday_releases/releases/assets/382849706", using: :curl,
      follow_location: true,
      headers: ["Accept: application/octet-stream"]
    sha256 "48f2a4bab080417370a5b6aaddde973ac8f8a52c9662fd379172dbc42a2197db"
  else
