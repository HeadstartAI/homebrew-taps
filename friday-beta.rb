class FridayBeta < Formula
  ...
  if Hardware::CPU.arm?
    url "https://api.github.com/repos/HeadstartAI/friday_releases/releases/assets/423837014", using: :curl,
      follow_location: true,
      headers: ["Accept: application/octet-stream"]
    sha256 "542488aca1393a5d1462f4e821e9b1c421023a6a5606d7ac1f585cee0911a29b"
  else
